...
| `Microsoft.CognitiveServices/accounts` | 2025-12-01 | <ul style="padding-left: 0px;"><li>[AzAdvertizer](https://www.azadvertizer.net/azresourcetypes/microsoft.cognitiveservices_accounts.html)</li><li>[Template reference](https://learn.microsoft.com/en-us/azure/templates/Microsoft.CognitiveServices/2025-12-01/accounts)</li></ul> |
...
| `Microsoft.CognitiveServices/accounts/projects` | 2025-09-01 | <ul style="padding-left: 0px;"><li>[AzAdvertizer](https://www.azadvertizer.net/azresourcetypes/microsoft.cognitiveservices_accounts_projects.html)</li><li>[Template reference](https://learn.microsoft.com/en-us/azure/templates/Microsoft.CognitiveServices/2025-09-01/accounts/projects)</li></ul> |
...
This instance deploys the Content Processing Solution Accelerator using only the required parameters.
...
The image tag for the container images.
...
| `containerAppUserIdentityId` | string | The user identity resource ID used for the Container App. |
| `containerAppUserPrincipalId` | string | The user identity Principal ID used for the Container App. |
...
| `br/public:avm/res/app/container-app:0.22.0` | Remote reference |
