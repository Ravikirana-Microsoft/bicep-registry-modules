...
var newWorkspaceResourceId = resourceId('Microsoft.OperationalInsights/workspaces', name)

#disable-next-line secure-secrets-in-params
var lawPrimarySharedKey = useExistingWorkspace
  ? listKeys(existingLogAnalyticsWorkspace!.id, '2025-02-01').primarySharedKey
  : listKeys(newWorkspaceResourceId, '2025-02-01').primarySharedKey
...
@secure()
output primarySharedKey string = lawPrimarySharedKey
