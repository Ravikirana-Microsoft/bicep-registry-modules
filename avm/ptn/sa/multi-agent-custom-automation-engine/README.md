...
- Required: No
- Type: string
- Default: `'latest_v3_2025-11-10_1406'`
...
| `azureAiSearchIndexName` | string | The name of the Azure AI Search index. |
...
| `azureStorageContainerName` | string | The name of the Azure Storage container. |
